function f=spher_harm_qlt(V,C,Xc,Yc,Zc,Order,Xe,Ye,Ze,tit)
% function f=spher_harm_qlt(V,C,Xc,Yc,Zc,Order,Xe,Ye,Ze);
...
Vfit = spher_harm_cmp(C,Xc,Yc,Zc,Order,Xe,Ye,Ze);
dV = V-Vfit;
