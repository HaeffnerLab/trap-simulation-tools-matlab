function el = set_dc(data,E,U,A,multipoleControls,regularize)
% function el = set_dc(data,Ex,Ey,Ez,U1,U2,U3,U4,U5,ax,az,phi,multipoleControls,regularize)
% set the dc voltages gor all dc electrodes.
% E,U and E,A are alternative input control combinations. 
% data is the usual data structure
% M8 = [Ex Ey Ez U1 U2 U3 U4 U5]', where
...
if multipoleControls
    ...
    M = vertcat(E,[U1 U2 U3 U4 U5]');
    el = data.trapConfiguration.multipoleControl*M;				% these are the electrode voltages
end

if regularize
    c = el;
    lambda = data.trapConfiguration.multipoleKernel\c;
    el = el-(data.trapConfiguration.multipoleKernel*lambda);
end
