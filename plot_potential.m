function plot_potential(A,I,J,K,grid,func,titleString,yLabel,varargin) % varargin = {outPath,pathSuffix}
% plot_potential(A,I,J,K,grid,f,titleString,yLabel,varargin)
