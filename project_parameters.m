...
%EC01 NUM_USED_ELECTRODES = 22;                                                  %%%% used in import_data
...
manualVoltages = ...                                                       % manualVoltages detrmines the voltages on the electrodes which are under manual control.
                 [0 0 0 0 0 ...                                            % It is a vector with NUM_ELECTRODES elements. See examples below. 
                  ...
                  0 -1]';                                                  %
                                                                           ...
                                                                           % manualElectrodes = [0 0 0 0]              |------------> EL_DC1, EL_DC2, EL_DC3, EL_DC4 in data.Simulation
                                                                           ...
                                                                           % electrodeMapping = [1 1; 2 1; 3 2; 4 3]   |
                                                                           % manualElectrodes = [1 1 0 0]              |------------> EL_DC1, EL_DC2, EL_DC3, EL_DC4 in data.Simulation
                                                                           ...
                                                                           % electrodeMapping = [1 1; 2 2; 3 3; 4 4]   |
                                                                           % manualElectrodes = [1 1 0 1]              |------------> EL_DC1, EL_DC2, EL_DC3, EL_DC4 in data.Simulation                                                                                                                                                  
...
%EC01 data.trapConfiguration.NUM_USED_ELECTRODES = NUM_USED_ELECTRODES;          % Number of electrodes to which DC voltage is applied. If two electrodes are shorted together, they count as one. 
...
data.trapConfiguration.manualVoltages = manualVoltages;
